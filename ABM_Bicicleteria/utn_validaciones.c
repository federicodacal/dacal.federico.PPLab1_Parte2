...
/**
 * \brief Solicita un sexo (masculino o femenino) al usuario, luego de verificarlo devuelve el resultado
 * \param pResultado Puntero al espacio de memoria donde se dejara el resultado de la funcion
 * \param longitud Es la longitud del array resultado
 * \param mensaje Es el mensaje a ser mostrado
 * \param mensajeError Es el mensaje de Error a ser mostrado
...
/**
 * \brief Solicita un rodado al usuario, luego de verificarlo devuelve el resultado
 * \param pResultado Puntero al espacio de memoria donde se dejara el resultado de la funcion
 * \param longitud Es la longitud del array resultado
 * \param mensaje Es el mensaje a ser mostrado
 * \param mensajeError Es el mensaje de Error a ser mostrado
...
int utn_getRodado(float* pResultado, char* mensaje, char* mensajeError, float minimo, float maximo, int reintentos)
{
	...
	while(reintentos>=0)
	{
		...
		if(getFloat(&bufferFloat) == 0)
		{
			if(bufferFloat >= minimo && bufferFloat <= maximo && validarRodados(&bufferFloat) == 0)
			{
				*pResultado = bufferFloat;
				retorno = 0;
				break;
...
/** \brief Valida sexo ingresado
 *
 * \param str char* puntero a string
...
/** \brief Valida que el rodado recibido
 *
 * \param rodado float* puntero a rodado
 * \return int -1 (Error) 0 (Exito)
 *
 */
 ...
 * \param dia int
 * \param mes int
 * \return int -1 (no es valida) o 0 (valida)
 *
 */
